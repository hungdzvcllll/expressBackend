...
var VnPayController = (function () {
    ...
    VnPayController.getLink = function (req, res) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = {};
                        return [4, service.getLink(req, res)];
                    case 1: return [2, _b.apply(_a, [(_c.mesage = _d.sent(), _c)])];
                    case 2:
                        e_1 = _d.sent();
    ...
    VnPayController.payResult = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, e_2;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _b = (_a = res.status(200)).json;
                        _c = {};
                        return [4, service.payResult(req, res)];
                    case 1: return [2, _b.apply(_a, [(_c.mesage = _d.sent(), _c)])];
                    case 2:
                        e_2 = _d.sent();
