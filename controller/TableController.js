...
var TableController = (function () {
    ...
    TableController.findAll = function (req, res) {
    ...
    TableController.findById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, e_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res.status(200)).json;
                        return [4, service.findById(req, res)];
                    case 1: return [2, _b.apply(_a, [_c.sent()])];
                    case 2:
                        e_2 = _c.sent();
    ...
    TableController.add = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3;
    ...
    TableController.stop = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, service.stopTable(req, res)];
                    case 1:
                        _a.sent();
                        return [2, res.status(200).json({ message: "success" })];
                    case 2:
    ...
    TableController.start = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, service.startTable(req, res)];
                    case 1:
                        _a.sent();
                        return [2, res.status(200).json({ message: "success" })];
                    case 2:
