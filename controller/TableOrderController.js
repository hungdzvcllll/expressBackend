...
var tableOrderService_1 = require("../service/tableOrderService");
var service = new tableOrderService_1.TableOrderService();
var TableOrderController = (function () {
    function TableOrderController() {
    }
    TableOrderController.order = function (req, res) {
    ...
    TableOrderController.cancel = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TableOrderController.findAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, e_3;
    ...
    TableOrderController.findYourOrder = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, e_4;
            return __generator(this, function (_c) {
                switch (_c.label) {
    ...
    TableOrderController.freeTime = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, e_5;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res.status(200)).json;
                        return [4, service.getFreeTime(req, res)];
                    case 1: return [2, _b.apply(_a, [_c.sent()])];
                    case 2:
                        e_5 = _c.sent();
