...
var DishService = (function () {
    ...
    DishService.prototype.findById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var idFind, obj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        idFind = Number(req.params.id);
                        return [4, dishRepo.findOne({ where: { id: idFind } })];
                    case 1:
                        obj = _a.sent();
                        if (obj == null)
                            return [2, {}];
                        return [2, { id: obj.id, name: obj.name, price: obj.price, image: obj.image }];
                }
            });
        });
    };
    DishService.prototype.add = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, price, fileName, save;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        save = new Dish_1.default(name, Number(price), "/dish/" + fileName, []);
                        return [4, dishRepo.save(save)];
                    case 1:
                        _c.sent();
                        return [2];
                }
