...
var Dish = (function () {
    function Dish(name, price, image, dishOrderDetails) {
        this.name = name;
        this.price = price;
        this.image = image;
    ...
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return DishOrderDetails_1.DishOrderDetails; }, function (dishOrderDetails) { return dishOrderDetails.dish; }),
