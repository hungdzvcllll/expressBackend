...
var DishOrderDetails_1 = require("./DishOrderDetails");
var DishOrder = (function () {
    function DishOrder(amount, status, dishOrderDetails, user) {
        this.amount = amount;
        this.status = status;
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return User_1.default; }, function (user) { return user.dishOrder; }),
        __metadata("design:type", User_1.default)
    ], DishOrder.prototype, "user", void 0);
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return DishOrderDetails_1.DishOrderDetails; }, function (dishOrderDetails) { return dishOrderDetails.dishOrder; }, { cascade: true }),
        __metadata("design:type", Array)
    ], DishOrder.prototype, "dishOrderDetails", void 0);
    DishOrder = __decorate([
        (0, typeorm_1.Entity)(),
