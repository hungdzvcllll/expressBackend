...
let DishOrderDetails = class DishOrderDetails {
    dishOrderId;
    dishId;
    quantity;
    priceOf1;
    dish;
    dishOrder;
    constructor(dishId, quantity, priceOf1) {
        this.dishId = dishId;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Dish_1.default, (dish) => dish.dishOrderDetails),
    (0, typeorm_1.JoinColumn)({ name: 'dishId' }),
    __metadata("design:type", Dish_1.default)
], DishOrderDetails.prototype, "dish", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => DishOrder_1.default, (dishOrder) => dishOrder.dishOrderDetails),
...
exports.DishOrderDetails = DishOrderDetails = __decorate([
    (0, typeorm_1.Entity)(),
